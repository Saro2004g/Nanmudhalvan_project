...
image = cv2.imread(r"D:\Nan Mudhalvan\Nan mudhalvan project\traffic_light_PNG56213.png") 
if image is None:
...
cap = cv2.VideoCapture(r"D:\Nan Mudhalvan\Nan mudhalvan project\istockphoto-1324876192-640_adpp_is.mp4")
